...
return [
    ...
    */
    'attributes' => [
        ...
        'color' => 'رنگ',
        'material' => 'جنس',
        'usage_degree' => 'درجه استفاده',
        'image' => 'تصویر',
        'gallery' => 'تصاویر گالری',
        'brand' => 'برند',
        'daily_price' => 'هزینه اجاره روزانه',
        'weekly_price' => 'هزینه اجاره هفتگی',
        'monthly_price' => 'هزینه اجاره ماهانه',
        'cash_collateral' => 'وثیقه نقدی',
        'non_cash_collateral' => 'وثیقه غیر نقدی',
    ],
];